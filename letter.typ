...
#let companyName = "Solar Monkey"
#let jobTitle = "Junior Platform Engineer"
...
I've also ventured into software development through projects like "SQLx VRChat SQLite Test", where I experimented with the SQLx crate in Rust and integrated it with VRChat's SQLite database. I've also made "Stock Crasher" a joke program that fetches stock prices from Yahoo Finance and then sends it to VRChat via OSC protocol, which is then displayed on the chatbox.
